...
# ----------------------------------------------------------------------------
# THEME / CUSTOM CSS — giao diện riêng, không dùng theme mặc định của Streamlit
# ----------------------------------------------------------------------------
st.markdown("""
<style>
...
# ----------------------------------------------------------------------------
# HERO HEADER (đổi theo trang đang chọn)
# ----------------------------------------------------------------------------
HERO_TEXT = {
...
if selected == "Khám phá dữ liệu":
    ...
    # ---- Insight tự động, tính toán từ dữ liệu thật ----
...
# ============================================================================
    ...
    if "res_df" in st.session_state and not st.session_state["res_df"].empty:
        ...
        # ---- Insight tự động dựa trên kết quả vừa chạy ----
